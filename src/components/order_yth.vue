          ...
          <div class="pro-list">
            <ul>
              <li class="flex-w" v-for='item in list'>
                ...
                <div class="pro-btns2">
                  <dl>
                    <dd class="cancel"  @click='orderDetail(item.billNo)'><span><i class="icon iconsfont icons-test"></i><span>订单详情</span></span></dd>
                    <dd><span><i class="icon iconsfont icons-pop"></i><span>去购买</span></span></dd>
                  </dl>
                </div>
              </li>
